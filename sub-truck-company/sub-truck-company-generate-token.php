                    ...
                    <table id="example" class="table table-striped table-bordered" style="width:100%">
                        ...
                        <tbody style="text-align: center;" id="tbody">
                            ...
                            <tr id="table" >
                                ...
                                <td><label class="badge badge-danger" style="font-size: 15px;"><?php echo $rtd['Token_Litres']; ?></label></td>
                                ...
                                <td>
                                        <?php 
                                        if($rtd['Status'] == "Approved"){ ?>
                                          <button type="submit" class="btn btn-disabled mr-2" name="" disabled=""><i class="mdi mdi-delete-forever"></i></button>
                                       <?php }else{ ?>
                                        <form method="POST">
