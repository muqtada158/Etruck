          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-12 doc-header">
                <a class="btn btn-success" href="petrol-station-search-token"><i class="mdi mdi-home mr-2"></i>Back to Petrol Station Tokens</a>
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="Post">
                    ...
                    <div class="form-group">
                      <label for="exampleInputUsername1"><strong> Token </strong><br> <?php echo $tdss['Token']; echo $TC_idforspentcapital;?></label>
                    </div>
                    <div class="form-group">
