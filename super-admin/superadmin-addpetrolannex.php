                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">Add Petrol Annex</h2>
                                </div>
                            </div>
                        </div>
                                 ...
                                 <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <div class="form-group">
                                            ...
                                            <input type="Date" id="company" placeholder="Enter the Transaction Date" class="form-control" name="addpstransactiondate" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="company" class=" form-control-label">Amount</label>
                                            <input type="number" id="company" placeholder="Enter the Amount" class="form-control" name="addpstansactionamount" required>
                                        </div>
                                        <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="file" id="file-input" name="addpstransactionannex" class="form-control-file" required>
                                                </div>
                                            </div>                                        
                                       <div class="card-footer">
                                        <button type="submit" class="btn btn-primary btn-sm" name="btn_addpslitreannex">
